...
import aiohttp
import argparse
from utils.banner import banner  # type: ignore
init(autoreset=True)
...
api_url = "https://hanafuda-backend-app-520478841386.us-central1.run.app/graphql"  # Ensure this API is correct
...
async def refresh_access_token(session, refresh_token):
    api_key = "AIzaSyDipzN0VRfTPnMGhQ5PSzO27Cxm3DohJGY"  # Replace with your actual API key
